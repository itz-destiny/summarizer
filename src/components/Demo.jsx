  ...
  return (
    <section className='mt-16 w-full max-w-wl'>
        ...
        <div className='flex flex-col w-full gap-2'>
            <form action="" className='relative flex justify-center
            items-center' onSubmit={handleSubmit}>
            ...
            <div className='flex flex-col gap-1 max-h-60 overflow-y-auto'>
                {allArticles.map((item, index) => (
                  ...
                  className='link_card'>
                    ...
                    text-blue-700 font-medium text-sm truncate'>{item.url}</p>
                  </div>
                ))}
            </div>
        </div>
